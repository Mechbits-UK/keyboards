...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER0] = LAYOUT_planck(
        RGB_TOG,  KC_Q,    RGB_MODE_PLAIN,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
        RGB_HUI,  RGB_HUD,    RGB_MODE_BREATHE,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        RGB_SAI, RGB_SAD,    RGB_MODE_KNIGHT,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
        RGB_VAI,  RGB_VAD, RGB_MODE_XMAS, RGB_TOG, MO(1),       KC_SPACE,       MO(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
    /* Lower
    * ,-----------------------------------------------------------------------------------.
    * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Bksp |
